    ...
    def dropna(
        ...
        *,
        ...
        def dropna(self, axis=0, how='any', thresh=None, subset=None, inplace=False):
            ...
            if axis in (0, "index"):
                column_types = [self[col].dtype for col in self.columns]
                print("DEBUG: Column types detected:", column_types)
                if len(set(column_types)) > 1:
                raise ValueError("Mixed data types detected: dropna() requires uniform column types.")
